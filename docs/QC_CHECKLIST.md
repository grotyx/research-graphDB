...
|------|------|----------|------|----------|--------------|------|
| 2026-03-17 | v1.27.0 | 5 | 5 | 0 | 2 | QC-2027-001~005: TERMINOLOGY 버전 v1.25.0→v1.27.0, SNOMED 세부카운트 218/214/195→235/231/200, EMBEDDING_CONTEXTUAL_PREFIX env var 추가, 12 orphan SNOMED(info), 89 reverse-map(info). 전부 즉시 해소. 3802 tests passed. |
