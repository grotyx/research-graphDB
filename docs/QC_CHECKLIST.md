...
|------|------|----------|------|----------|--------------|------|
| 2026-03-18 | v1.30.0 | 3 | 3 | 0 | 2 | QC-2030-001(MCP Docker→1.30.0 restart), QC-2030-002(reranker test provider fix), QC-2030-003(GRAPH_SCHEMA stats label v1.24.0→v1.30.0). 전부 해소. 4065 tests. |
