...
|------|------|----------|------|----------|--------------|------|
| 2026-03-18 | v1.29.0 | 6 | 6 | 1 | 11 | 고아chunk 20건 삭제, 대소문자중복 4건 병합(Anterior Fixation/Fusion, Neurogenic Claudication, cervical), 고립Paper 4건 복구(cervical trauma), TREATS 166건 갱신, study_design 90건 정규화(other→Other, meta-analysis→Meta-Analysis 등). EL 정합성 양호(7개 정규값, 비정규 0). DB: Paper 743, Chunk 10678 |
