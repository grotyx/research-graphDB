...
|----|-------|--------|------|------|----------|------|
| DV-NEW-015 | 6.1 | Low | 정보 | IS_A 계층 커버리지 — Intervention 56.5%, Pathology 41.1%, Anatomy 28.4%, Outcome 7.8%. schema.py에 Intervention 추가 + build/repair_ontology 실행으로 Intervention 개선. 나머지는 점진적 개선 | v1.24.0 | 🟡 보류 (점진적 개선) |
