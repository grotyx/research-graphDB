...
|----|-------|--------|------|------|----------|------|
| DV-001 | 4.6 | Medium | 원인 | secondary entity 8개 타입 정규화 누락 (RiskFactor, Complication 등) → 대소문자 변형 중복 가능 | v1.21.2 | 🔴 |
| DV-002 | 1.2 | Low | 원인 | snomed_enricher.py Anatomy MERGE 시 정규화 미적용 (segment 분리 후 raw name 사용) | v1.21.2 | 🔴 |
