...
|----|-------|--------|------|------|----------|------|
| DV-NEW-006 | 4.2/6.4 | Info | 정보 | SNOMED 커버리지 — v1.24.1 기준: I:44.2%, P:57.2%, O:26.1%, A:91.1%. 매핑 653개 + enrich 실행 완료 | v1.23.4 | 🟡 허용 (모니터링) |
...
| DV-NEW-013 | 4.5 | Medium | 원인 | SNOMED source↔Neo4j 코드 불일치 — v1.24.1에서 enrich_graph_snomed.py 재실행으로 대부분 해소. 잔여 불일치는 alias 노드 (DV-A-006 허용) | v1.24.0 | 🟡 허용 (enrich 완료) |
...
| DV-NEW-017 | 2.3 | Low | 증상 | TREATS paper_count 불일치 — v1.24.1 재스캔에서 해소 확인 (enrich 재실행으로 재계산) | v1.24.0 | 🟡 모니터링 |
| DV-NEW-018 | 3.2 | Low | 증상 | Abstract 임베딩 누락 — v1.24.1 재스캔에서 해소 확인 | v1.24.0 | ✅ 해소 |
