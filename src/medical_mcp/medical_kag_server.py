...
def create_mcp_server(kag_server: MedicalKAGServer) -> Any:
    ...
    async def list_tools() -> list[Tool]:
        ...
        Tool definitions extracted to tool_definitions.py (D-012).
        """
        from medical_mcp.tool_definitions import get_tool_definitions
        return get_tool_definitions(Tool, ToolAnnotations)
