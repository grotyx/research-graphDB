"""Study Type Detector v1.0 (Archived).

Archived on: 2025-12-18
Reason: Replaced by simplified v7.0 processing pipeline

This module provided rule-based study type detection without LLM calls.
It used MeSH Terms, Publication Types, and abstract keywords to detect
study types and recommend appropriate effect measures.

v7.0 simplifies study classification and relies on analysis tools
for statistical values instead of LLM extraction.
