...
SPINE_INTERVENTION_SNOMED: dict[str, SNOMEDMapping] = {
    ...
    "ADR": SNOMEDMapping(
        ...
        abbreviations=["ADR", "TDR", "lTDR"],  # v1.25.0: cTDR moved to CDR (cervical)
...
# =================================================================
    ...
    # === v1.19.2 EXPANSION: Bone Grafts, Robotics, Endoscopy, Implants ===
    # Extension codes: 900000000000180 ~ 900000000000197

    "rhBMP-2": SNOMEDMapping(
        code="900000000000180",
        term="Recombinant human bone morphogenetic protein 2 application",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["rhBMP-2 augmentation", "BMP-2", "BMP-2 grafting", "rhBMP-2 fusion material",
                  "rh-BMP2", "BMP augmentation", "BMP supplementation", "BMP graft",
                  "E.BMP-2", "rhBMP-2 with HA", "rhBMP-2/ACS", "BMP"],
        abbreviations=["rhBMP-2", "BMP-2"],
        korean_term="재조합 인간 골형성 단백질-2 적용",
        notes="Osteoinductive growth factor used as bone graft substitute in spinal fusion",
    ),
    "PEID": SNOMEDMapping(
        code="900000000000181",
        ...
        synonyms=["Percutaneous endoscopic interlaminar approach",
                  "Interlaminar endoscopic discectomy"],
        abbreviations=["PEID"],
        korean_term="경피적 내시경 추궁간 디스크 절제술",
    ),
    "PETD": SNOMEDMapping(
        code="900000000000182",
        ...
        korean_term="경피적 내시경 추간공 디스크 절제술",
    ),
    # v1.25.0: PCO merged into SPO entry (same procedure; SPO already has PCO as abbreviation)
    "CDA": SNOMEDMapping(
        code="900000000000184",
        term="Cervical disc arthroplasty",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Cervical disc replacement", "Cervical total disc replacement",
                  "Cervical artificial disc", "CDR"],
        abbreviations=["CDA", "CDR"],
        korean_term="경추 인공디스크 치환술",
    ),
    "Pedicle screw instrumentation": SNOMEDMapping(
        code="900000000000185",
        term="Pedicle screw instrumentation of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Pedicle screw fixation", "Pedicle screw insertion",
                  "pedicle screw and rod instrumentation",
                  "Bilateral pedicle screw instrumentation",
                  "Unilateral pedicle screw instrumentation"],
        korean_term="척추경 나사못 기기 고정술",
    ),
    "Interbody cage implantation": SNOMEDMapping(
        code="900000000000186",
        term="Interbody cage implantation",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["cage implantation", "Interbody cage placement", "Interbody spacer",
                  "PEEK interbody cage", "Expandable cage", "Expandable cages",
                  "intervertebral cage", "Long cage", "Short cage",
                  "Interbody fusion with porous cages"],
        korean_term="추체간 케이지 삽입술",
    ),
    "Robot-assisted spine surgery": SNOMEDMapping(
        code="900000000000187",
        term="Robot-assisted spine surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Robotic spine surgery", "Robot-assisted pedicle screw",
                  "Robot-assisted screw placement", "Robot-assisted fusion",
                  "Robot-assisted lumbar fusion", "Robotic pedicle screw placement",
                  "Robot-assisted CBT screw placement",
                  "Robotic arm-guided pedicle screw placement",
                  "Robot-assisted pedicle screw", "RA-PPSI"],
        korean_term="로봇 보조 척추 수술",
    ),
    "Navigation-guided spine surgery": SNOMEDMapping(
        code="900000000000188",
        term="Navigation-guided spine surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Navigation-guided pedicle screw insertion",
                  "Navigation-guided pedicle screw",
                  "Navigation-guided lumbar fusion",
                  "Navigation-assisted PPSI",
                  "Non-robotic navigation"],
        korean_term="네비게이션 유도 척추 수술",
    ),
    "Dural repair": SNOMEDMapping(
        code="900000000000189",
        term="Repair of dura mater",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Dural closure", "Dural suture", "Duraplasty"],
        korean_term="경막 수복술",
    ),
    "Allograft bone grafting": SNOMEDMapping(
        code="900000000000190",
        term="Allograft bone grafting of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["allograft", "Structural femoral allograft",
                  "map3 cellular allogeneic bone graft", "bone allograft"],
        korean_term="동종골 이식술",
    ),
    "Autograft bone grafting": SNOMEDMapping(
        code="900000000000191",
        term="Autograft bone grafting of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["autograft", "Autogenous bone graft", "Local autograft",
                  "auto-iliac bone graft", "Bone marrow aspirate"],
        korean_term="자가골 이식술",
    ),
    "Posterior stabilization": SNOMEDMapping(
        code="900000000000192",
        term="Posterior stabilization of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Posterior fixation", "Posterior instrumentation",
                  "Posterior wiring"],
        korean_term="후방 안정화술",
    ),
    "Laminar reconstruction": SNOMEDMapping(
        code="900000000000193",
        term="Laminar reconstruction of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Laminoplasty reconstruction",
                  "PEEK artificial lamina reconstruction"],
        korean_term="추궁판 재건술",
    ),
    "Minimally Invasive Decompression": SNOMEDMapping(
        code="900000000000194",
    ...
    "Demineralized bone matrix": SNOMEDMapping(
        code="900000000000195",
        term="Demineralized bone matrix grafting",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["DBM gel", "demineralized bone matrix", "DBM grafting",
                  "synthetic bone graft", "Bone substitute implantation",
                  "SiCaP grafting"],
        abbreviations=["DBM"],
        korean_term="탈회골 기질 이식술",
    ),
    "Bone graft augmentation": SNOMEDMapping(
        code="900000000000196",
        term="Bone graft augmentation of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["BMP augmentation", "rhBMP-2 augmentation",
                  "Bone marrow aspirate concentrate"],
        korean_term="골 이식 보강술",
    ),
    "Flavectomy": SNOMEDMapping(
        code="900000000000197",
        term="Flavectomy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Ligamentum flavum resection", "Ligamentum flavum removal",
                  "Yellow ligament excision"],
        korean_term="황색인대 절제술",
    ),
    "Bariatric Surgery": SNOMEDMapping(
        code="427127002",
        term="Bariatric surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        synonyms=["Weight loss surgery", "Obesity surgery",
                  "sleeve gastrectomy", "RYGB", "gastric banding", "MBS"],
        korean_term="비만 수술",
    ),
    "Closed reduction": SNOMEDMapping(
        code="44948003",
        term="Closed reduction of fracture",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        synonyms=["Closed fracture reduction", "manual reduction"],
        korean_term="비관혈적 정복술",
    ),
    "Open reduction": SNOMEDMapping(
        code="21784002",
        term="Open reduction of fracture",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
    ...
    # === DV-NEW-001: Orphan Alias Target Extensions (Interventions) ===
    "Anterior Decompression": SNOMEDMapping(
        code="900000000000198",
        term="Anterior decompression of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Anterior spinal decompression"],
        korean_term="전방 감압술",
    ),
    "Asymmetric PSO": SNOMEDMapping(
    ...
    "BMP": SNOMEDMapping(
        code="900000000000622",
        term="Bone morphogenetic protein application",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Bone Morphogenetic Protein", "BMP-2", "Infuse"],
        abbreviations=["BMP", "rhBMP-2"],
        korean_term="골형성단백질",
    ),
    "Cell Saver": SNOMEDMapping(
        code="900000000000623",
        term="Intraoperative cell salvage",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Intraoperative cell salvage", "Autologous blood transfusion"],
        korean_term="수술중 자가혈 회수",
    ),
    "Cement Augmented Screw": SNOMEDMapping(
        code="900000000000624",
        term="Cement augmented pedicle screw fixation",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Cement augmented pedicle screw", "PMMA augmented screw",
                  "Fenestrated screw"],
        korean_term="시멘트 보강 나사 고정",
    ),
    "Circumferential Fusion": SNOMEDMapping(
        code="900000000000625",
        term="Circumferential spinal fusion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["360 fusion", "Combined anterior-posterior fusion",
                  "360-degree fusion"],
        korean_term="전후방 동시 유합술",
    ),
    "DBM": SNOMEDMapping(
        code="900000000000626",
        term="Demineralized bone matrix grafting",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Demineralized Bone Matrix"],
        abbreviations=["DBM"],
        korean_term="탈회골 기질",
    ),
    "Endoscopic ACDF": SNOMEDMapping(
        code="900000000000627",
        term="Endoscopic anterior cervical discectomy and fusion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Endoscopic anterior cervical discectomy"],
        korean_term="내시경 경추 전방 수술",
    ),
    "Endoscopic Foraminotomy": SNOMEDMapping(
        code="900000000000628",
        term="Endoscopic foraminotomy of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Percutaneous endoscopic foraminotomy",
                  "Full-endoscopic foraminotomy"],
        korean_term="내시경 추간공 확장술",
    ),
    "Exercise Therapy": SNOMEDMapping(
        code="900000000000629",
        term="Therapeutic exercise for spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Therapeutic exercise", "Core strengthening",
                  "Stabilization exercise"],
        korean_term="운동 치료",
    ),
    "Hemilaminectomy": SNOMEDMapping(
        code="900000000000630",
        term="Hemilaminectomy of vertebra",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Hemi-laminectomy", "Unilateral laminectomy"],
        korean_term="편측 후궁 절제술",
    ),
    "Intraoperative Neuromonitoring": SNOMEDMapping(
        code="900000000000631",
        term="Intraoperative neurophysiological monitoring",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Intraoperative monitoring", "Neuromonitoring"],
        abbreviations=["IONM", "IOM"],
        korean_term="수술중 신경 모니터링",
    ),
    "Lateral Corpectomy": SNOMEDMapping(
        code="900000000000632",
        term="Lateral approach corpectomy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Mini-open corpectomy"],
        korean_term="측방 추체 절제술",
    ),
    "Minimally Invasive Surgery": SNOMEDMapping(
        code="900000000000633",
        term="Minimally invasive spine surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Minimally invasive spine surgery",
                  "Minimally invasive procedure"],
        abbreviations=["MIS", "MISS"],
        korean_term="최소침습 수술",
    ),
    "Oblique Corpectomy": SNOMEDMapping(
        code="900000000000634",
        term="Oblique lateral corpectomy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Oblique lateral corpectomy"],
        korean_term="사방향 추체 절제술",
    ),
    "Percutaneous Disc Decompression": SNOMEDMapping(
        code="900000000000635",
        term="Percutaneous disc decompression procedure",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Nucleoplasty", "Disc-FX",
                  "Intradiscal electrothermal therapy"],
        abbreviations=["IDET"],
        korean_term="경피적 디스크 감압술",
    ),
    "Posterior Column Osteotomy": SNOMEDMapping(
    ...
    "Posterior Decompression": SNOMEDMapping(
        code="900000000000637",
        term="Posterior decompression of spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Posterior spinal decompression"],
        korean_term="후방 감압술",
    ),
    "Prolotherapy": SNOMEDMapping(
        code="900000000000638",
        term="Prolotherapy injection for spine",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Dextrose prolotherapy"],
        korean_term="프롤로 치료",
    ),
    "Rehabilitation": SNOMEDMapping(
        code="900000000000639",
        term="Spine rehabilitation therapy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Postoperative rehabilitation", "Spine rehabilitation"],
        korean_term="척추 재활",
    ),
    "TXA": SNOMEDMapping(
        code="900000000000640",
        term="Tranexamic acid administration",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Tranexamic acid"],
        abbreviations=["TXA"],
        korean_term="트라넥삼산 투여",
    ),
    "Wound VAC": SNOMEDMapping(
        code="900000000000641",
        term="Vacuum-assisted wound closure",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        is_extension=True,
        synonyms=["Vacuum-assisted closure", "Negative pressure wound therapy"],
        abbreviations=["NPWT"],
    ...
    # ============================================================
    # v1.25.0: New Concepts (procedure_ext2 range 700+)
    # ============================================================
    "Expandable Cage": SNOMEDMapping(
        code="900000000000700",
        term="Expandable interbody cage insertion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="609588000",  # Interbody fusion
        is_extension=True,
        synonyms=["Expandable cage", "Expandable interbody spacer", "Articulating expandable cage"],
        korean_term="확장형 케이지 삽입",
    ),
    "Zero-Profile Device": SNOMEDMapping(
        code="900000000000701",
        term="Zero-profile anterior cervical interbody device",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="112728004",  # ACDF
        is_extension=True,
        synonyms=["Zero-profile cage", "Stand-alone anterior cage", "Zero-P device"],
        korean_term="제로 프로파일 경추 디바이스",
    ),
    "Endoscopic OLIF": SNOMEDMapping(
        code="900000000000702",
        term="Endoscopic oblique lumbar interbody fusion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="900000000000101",  # OLIF
        is_extension=True,
        synonyms=["Endoscopic OLIF", "Endo-OLIF", "Full-endoscopic OLIF"],
        korean_term="내시경 사측방 유합술",
    ),
    "Robot-Assisted UBE": SNOMEDMapping(
        code="900000000000703",
        term="Robot-assisted unilateral biportal endoscopic surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="900000000000105",  # UBE
        is_extension=True,
        synonyms=["Robotic UBE", "Robot-assisted biportal endoscopy"],
        abbreviations=["RA-UBE"],
        korean_term="로봇 보조 양측 내시경 수술",
    ),
    "AR-Guided Surgery": SNOMEDMapping(
        code="900000000000704",
        term="Augmented reality guided spine surgery",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="386638009",  # Endoscopic spinal procedure
        is_extension=True,
        synonyms=["AR-guided pedicle screw placement", "AR navigation", "Augmented reality navigation"],
        abbreviations=["AR"],
        korean_term="증강현실 가이드 척추 수술",
    ),
    "Romosozumab": SNOMEDMapping(
        code="900000000000705",
        term="Romosozumab therapy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="900000000000641",  # Conservative Management
        is_extension=True,
        synonyms=["Evenity", "Anti-sclerostin antibody", "Romosozumab treatment"],
        korean_term="로모소주맙 치료",
    ),
    "Abaloparatide": SNOMEDMapping(
        code="900000000000706",
        term="Abaloparatide therapy",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="900000000000641",  # Conservative Management
        is_extension=True,
        synonyms=["Tymlos", "PTHrP analog", "Abaloparatide treatment"],
        korean_term="아발로파라타이드 치료",
    ),
    "Standalone Cage": SNOMEDMapping(
        code="900000000000707",
        term="Stand-alone interbody cage insertion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="609588000",  # Interbody fusion
        is_extension=True,
        synonyms=["Stand-alone cage", "Standalone cage", "Cage-only fusion",
                  "Stand-alone PEEK cage", "Standalone ALIF cage"],
        korean_term="단독 케이지 삽입술",
    ),
    "3D-Printed Implant": SNOMEDMapping(
        code="900000000000708",
        term="3D-printed spinal implant insertion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="609588000",  # Interbody fusion
        is_extension=True,
        synonyms=["3D-printed titanium cage", "3D-printed cage", "Custom 3D implant",
                  "Additive manufactured cage"],
        korean_term="3D 프린팅 임플란트 삽입술",
    ),
    "Endoscopic Posterior Fusion": SNOMEDMapping(
        code="900000000000709",
        term="Endoscopic posterior lumbar interbody fusion",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="386638009",  # Endoscopic spinal procedure
        is_extension=True,
        synonyms=["Endo-PLIF", "Endoscopic PLIF", "Full-endoscopic posterior fusion"],
        korean_term="내시경 후방 유합술",
    ),
    "Percutaneous Cement Discoplasty": SNOMEDMapping(
        code="900000000000710",
        term="Percutaneous cement discoplasty",
        semantic_type=SNOMEDSemanticType.PROCEDURE,
        parent_code="900000000000115",  # Vertebral Augmentation
        is_extension=True,
...
# ========================================
    ...
    "Neurogenic claudication": SNOMEDMapping(
        code="31781004",
    ...
    "Cervical spondylotic disease": SNOMEDMapping(
        code="288237004",
    ...
    "Discogenic low back pain": SNOMEDMapping(
        ...
        synonyms=["Discogenic pain", "Disc-related low back pain",
                  "Discogenic LBP"],
        korean_term="추간판성 요통",
    ),
    "Lumbar deformity": SNOMEDMapping(
        code="900000000000235",
        ...
        synonyms=["Lumbar deformity", "lumbar degeneration",
                  ...
                  "lumbar spinal degeneration", "Lumbar spine pathology (unspecified)",
                  "Lumbar disk degeneration"],
        korean_term="요추 변형",
    ),
    "Cage subsidence": SNOMEDMapping(
        code="900000000000236",
        ...
        korean_term="케이지 침하",
        notes="Postoperative complication where interbody cage sinks into vertebral endplate",
    ),
    "Transverse ligament rupture": SNOMEDMapping(
        code="900000000000237",
    ...
    "Facet joint violation": SNOMEDMapping(
        code="900000000000238",
    ...
    "Atlantoaxial rotatory fixation": SNOMEDMapping(
        code="900000000000239",
        ...
        abbreviations=["AARF"],
        korean_term="환축추 회전 고정",
    ),
    "Coronal malalignment": SNOMEDMapping(
        code="900000000000240",
    ...
    "Pedicle screw loosening": SNOMEDMapping(
        code="900000000000241",
    ...
    "Postoperative spinal epidural hematoma": SNOMEDMapping(
        code="900000000000242",
        ...
        abbreviations=["PSEH"],
        korean_term="수술 후 척추 경막외 혈종",
    ),
    "Paraspinal muscle degeneration": SNOMEDMapping(
        code="900000000000243",
    ...
    "Cage migration": SNOMEDMapping(
        code="900000000000244",
    ...
    "Spinopelvic misalignment": SNOMEDMapping(
        code="900000000000245",
    ...
    "C5 palsy": SNOMEDMapping(
        ...
        notes="Postoperative complication after cervical surgery, typically deltoid weakness",
    ),
    "Instrumentation failure": SNOMEDMapping(
        code="900000000000247",
    ...
    "Spondylitis with epidural abscess": SNOMEDMapping(
        code="900000000000248",
    ...
    "Thoracic stenosis": SNOMEDMapping(
        code="900000000000249",
    ...
    "Neuroforaminal compression": SNOMEDMapping(
    ...
    "Vertebral instability": SNOMEDMapping(
        code="900000000000251",
    ...
    "C1/2 facet joint asymmetry": SNOMEDMapping(
        code="900000000000252",
    ...
    "Lytic bone disease": SNOMEDMapping(
        code="900000000000253",
    ...
    "Vertebral artery anomaly": SNOMEDMapping(
        code="900000000000254",
    ...
    "Segmental motor paralysis": SNOMEDMapping(
        code="900000000000255",
    ...
    "Lumbar central canal stenosis": SNOMEDMapping(
        code="900000000000256",
        term="Lumbar central canal stenosis",
        semantic_type=SNOMEDSemanticType.DISORDER,
        is_extension=True,
        parent_code="18347007",  # Lumbar spinal stenosis
        synonyms=["Central stenosis", "Lumbar degenerative spinal stenosis",
                  "Lumbar stenosis with neural compression",
                  "Lumbar stenosis requiring laminectomy"],
        korean_term="요추 중심관 협착증",
    ),
    "Intervertebral disc disease": SNOMEDMapping(
        code="900000000000257",
    ...
    "Craniovertebral junction disorder": SNOMEDMapping(
        code="900000000000258",
        ...
        korean_term="두개경추 접합부 질환",
    ),
    "Intraoperative contamination": SNOMEDMapping(
        code="900000000000259",
    ...
    "Spinal cord degeneration": SNOMEDMapping(
        code="900000000000260",
    ...
    "Axial Low Back Pain": SNOMEDMapping(
        code="900000000000264",
    ...
    "Cervical Kyphosis": SNOMEDMapping(
        code="900000000000265",
    ...
    "Chiari Malformation": SNOMEDMapping(
        code="900000000000266",
    ...
    "Coccygodynia": SNOMEDMapping(
        code="900000000000267",
        term="Coccygodynia",
        semantic_type=SNOMEDSemanticType.DISORDER,
        is_extension=True,
        parent_code="900000000000648",  # Spinal Pain Syndrome
    ...
    "Coronal Imbalance": SNOMEDMapping(
        code="900000000000268",
    ...
    "Epidural Fibrosis": SNOMEDMapping(
        code="900000000000269",
    ...
    "Facet Dislocation": SNOMEDMapping(
        code="900000000000270",
    ...
    "Fixed Sagittal Imbalance": SNOMEDMapping(
        code="900000000000271",
    ...
    "Iatrogenic Flat Back": SNOMEDMapping(
        code="900000000000272",
    ...
    "Lateral Recess Stenosis": SNOMEDMapping(
        code="900000000000273",
    ...
    "Lumbar Spondylosis": SNOMEDMapping(
        code="900000000000274",
    ...
    "Neck Pain": SNOMEDMapping(
        code="900000000000275",
        term="Cervicalgia",
        semantic_type=SNOMEDSemanticType.DISORDER,
        is_extension=True,
        parent_code="900000000000648",  # Spinal Pain Syndrome
    ...
    "Neuropathic Pain": SNOMEDMapping(
        code="900000000000277",
    ...
    "Osteoporotic Vertebral Fracture": SNOMEDMapping(
        code="900000000000278",
        ...
        korean_term="골다공증성 척추 압박 골절",
    ),
    "PJK": SNOMEDMapping(
        code="900000000000279",
        term="Proximal junctional kyphosis",
        semantic_type=SNOMEDSemanticType.DISORDER,
        is_extension=True,
        parent_code="900000000000647",  # Surgical Complication
        ...
        korean_term="근위부 접합부 후만",
    ),
    "Pathological Fracture": SNOMEDMapping(
        code="900000000000280",
    ...
    "Post-laminectomy Syndrome": SNOMEDMapping(
        code="900000000000281",
    ...
    "Radicular Pain": SNOMEDMapping(
        code="900000000000282",
    ...
    "Rotatory Subluxation": SNOMEDMapping(
        code="900000000000283",
    ...
    "Sacroiliac Joint Dysfunction": SNOMEDMapping(
        code="900000000000284",
    ...
    "Scoliosis": SNOMEDMapping(
        code="900000000000285",
    ...
    "Spinal AVM": SNOMEDMapping(
        code="900000000000286",
        ...
        abbreviations=["SDAVF"],
        korean_term="척추 동정맥 기형",
    ),
    "Spinal Cord Injury": SNOMEDMapping(
        code="900000000000287",
    ...
    "Spinal Cord Tumor": SNOMEDMapping(
        code="900000000000288",
    ...
    "Spinal Dysraphism": SNOMEDMapping(
        code="900000000000289",
    ...
    "Subaxial Cervical Spine Injury": SNOMEDMapping(
        code="900000000000290",
    ...
    "Syringomyelia": SNOMEDMapping(
        code="900000000000291",
        term="Syringomyelia",
        semantic_type=SNOMEDSemanticType.DISORDER,
        is_extension=True,
        parent_code="900000000000646",  # Neurological Spine Condition
    ...
    "Tandem Stenosis": SNOMEDMapping(
        code="900000000000292",
    ...
    "Thoracic Disc Herniation": SNOMEDMapping(
        code="900000000000293",
    ...
    "Vertebral Fracture": SNOMEDMapping(
        code="900000000000294",
    ...
    "Vertebral Osteomyelitis": SNOMEDMapping(
        code="900000000000295",
    ...
    # ============================================================
    # v1.25.0: New Pathology Concepts (disorder_ext range 900+)
    # ============================================================
    "Rod Breakage": SNOMEDMapping(
        code="900000000000900",
        term="Rod fracture of spinal instrumentation",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
        synonyms=["Rod fracture (pathology)", "Broken rod", "Spinal rod failure"],
        korean_term="로드 파절",
    ),
    "Screw Pullout": SNOMEDMapping(
        code="900000000000901",
        term="Pedicle screw pullout",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
        synonyms=["Screw loosening (pathology)", "Screw migration", "Pedicle screw failure"],
        korean_term="나사못 이탈",
    ),
    "Epidural Lipomatosis": SNOMEDMapping(
        code="900000000000902",
        term="Spinal epidural lipomatosis",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="49049000",  # Degenerative Spine Disease
        is_extension=True,
        synonyms=["Epidural fat hypertrophy", "SEL", "Spinal lipomatosis"],
        korean_term="경막외 지방종증",
    ),
    "Vertebral Hemangioma (Aggressive)": SNOMEDMapping(
        code="900000000000903",
        term="Aggressive vertebral hemangioma",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000650",  # Spinal Neoplasm
        is_extension=True,
        synonyms=["Symptomatic vertebral hemangioma", "Compressive hemangioma"],
        korean_term="공격적 척추 혈관종",
    ),
    "Dropped Head Syndrome": SNOMEDMapping(
        code="900000000000904",
        term="Dropped head syndrome",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000642",  # Spinal Deformity
        is_extension=True,
        synonyms=["Chin-on-chest deformity", "Severe cervical kyphosis", "Head drop"],
        korean_term="수하두 증후군",
    ),
    "Spinal Subdural Hematoma": SNOMEDMapping(
        code="900000000000905",
        term="Spinal subdural hematoma",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
        synonyms=["Subdural hematoma of spine", "SSDH"],
        korean_term="척추 경막하 혈종",
    ),
    "Implant Allergy": SNOMEDMapping(
        code="900000000000906",
        term="Spinal implant metal allergy",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
        synonyms=["Metal allergy", "Titanium allergy", "Nickel hypersensitivity"],
        korean_term="임플란트 금속 알레르기",
    ),
    "Vertebral Endplate Degeneration": SNOMEDMapping(
        code="900000000000907",
        term="Vertebral endplate degeneration",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="49049000",  # Degenerative Spine Disease
        is_extension=True,
        synonyms=["Endplate erosion", "Endplate Modic changes", "Endplate signal changes"],
        korean_term="추체 종판 퇴행",
    ),
    "Proximal Junctional Failure": SNOMEDMapping(
        code="900000000000908",
        term="Proximal junctional failure",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
        synonyms=["PJF", "Proximal junctional fracture", "Acute PJK failure"],
        korean_term="근위부 접합부 부전",
    ),
    "Distal Junctional Failure": SNOMEDMapping(
        code="900000000000909",
        term="Distal junctional failure",
        semantic_type=SNOMEDSemanticType.DISORDER,
        parent_code="900000000000647",  # Surgical Complication
        is_extension=True,
...
# === PAIN MEASURES - Cervical ===
    ...
    # === v1.19.2 EXPANSION: Clinical Outcomes, Complications, Biomechanics ===
    # Official SNOMED codes + Extension codes: 900000000000343 ~ 900000000000370

    "Postoperative Delirium": SNOMEDMapping(
        code="2776000",
        term="Delirium",
        semantic_type=SNOMEDSemanticType.FINDING,
        parent_code="900000000000657",  # Complication Outcome
    ...
    "Range of Motion": SNOMEDMapping(
        ...
        abbreviations=["ROM"],
        korean_term="관절 가동 범위",
    ),
    "Pulmonary Embolism": SNOMEDMapping(
        code="59282003",
    ...
    "Screw Loosening": SNOMEDMapping(
        code="900000000000343",
    ...
    "Rod Fracture": SNOMEDMapping(
        code="900000000000344",
    ...
    "Opioid Consumption": SNOMEDMapping(
        code="900000000000345",
    ...
    "Screw Accuracy": SNOMEDMapping(
        code="900000000000346",
        ...
        synonyms=["Screw Accuracy", "Screw accuracy rate",
                  ...
                  "Robot vs Freehand - Accuracy"],
        korean_term="나사못 삽입 정확도",
        notes="Typically assessed by Gertzbein-Robbins classification (Grade A/B acceptable)",
    ),
    "Spinal Stiffness": SNOMEDMapping(
        code="900000000000347",
    ...
    "Transient Thigh Symptoms": SNOMEDMapping(
        code="900000000000348",
        ...
        synonyms=["LLIF - Transient Thigh Symptoms",
                  ...
                  "Thigh numbness after XLIF",
                  "Hip flexion weakness"],
        korean_term="일과성 대퇴 증상",
        notes="Common complication of lateral interbody fusion (XLIF/LLIF/OLIF) due to psoas retraction",
    ),
    "Radiation Exposure": SNOMEDMapping(
        code="900000000000349",
    ...
    "Transfusion Requirement": SNOMEDMapping(
        code="900000000000350",
    ...
    "Overall Mechanical Complications": SNOMEDMapping(
        code="900000000000351",
        ...
        korean_term="전체 기계적 합병증률",
    ),
    "Von Mises Stress": SNOMEDMapping(
        code="900000000000352",
        ...
        notes="Biomechanical outcome from finite element analysis",
    ),
    "Complete Anatomical Reduction": SNOMEDMapping(
        code="900000000000353",
        ...
        korean_term="완전 해부학적 정복률",
    ),
    "Solid Fusion": SNOMEDMapping(
        code="900000000000354",
        term="Solid fusion rate",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        is_extension=True,
        parent_code="900000000000306",  # Fusion Rate
        synonyms=["Solid Fusion - Clinical or Radiological Signs",
                  "Solid arthrodesis", "Confirmed fusion",
                  "Fusion Rate at 6 Months"],
        korean_term="견고한 유합률",
    ),
    "Muscle Cross-sectional Area": SNOMEDMapping(
        code="900000000000355",
    ...
    "Muscle Fat Infiltration": SNOMEDMapping(
        code="900000000000356",
    ...
    "Intraoperative Revision Rate": SNOMEDMapping(
        code="900000000000357",
        ...
        korean_term="수술 중 재삽입률",
    ),
    "Bone Mineral Density": SNOMEDMapping(
        code="312681000",
    ...
    "Adjacent Segment Degeneration": SNOMEDMapping(
        code="900000000000358",
        ...
        abbreviations=["ASD"],
        korean_term="인접 분절 퇴행률",
        notes="Radiographic or clinical degeneration at levels adjacent to fusion",
    ),
    "Sagittal Disc Angle": SNOMEDMapping(
        code="900000000000359",
        ...
        korean_term="시상면 추간판 각도",
    ),
    "Quality of Life - SF-36": SNOMEDMapping(
        code="900000000000360",
        term="Quality of life measured by SF-36",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        is_extension=True,
        parent_code="445537008",  # SF-36
        synonyms=["Quality of Life - SF-36", "SF-36 QoL",
                  "Quality of life outcomes"],
        korean_term="SF-36 삶의 질",
    ),
    "Endplate Damage": SNOMEDMapping(
        code="900000000000361",
    ...
    "Heterotopic Ossification Rate": SNOMEDMapping(
        code="900000000000362",
    ...
    "Osteolysis Rate": SNOMEDMapping(
        code="900000000000363",
    ...
    "Pelvic Incidence": SNOMEDMapping(
        code="900000000000364",
        ...
        abbreviations=["PI"],
        korean_term="골반 입사각",
        notes="Fixed anatomical parameter; key spinopelvic parameter with PI-LL mismatch",
    ),
    "Sacral Slope": SNOMEDMapping(
        code="900000000000365",
    ...
    "BMP Complication Rate": SNOMEDMapping(
        code="900000000000366",
        ...
        korean_term="BMP 관련 합병증률",
    ),
    "Cage Subsidence Rate": SNOMEDMapping(
        code="900000000000367",
    ...
    "Pseudarthrosis Rate": SNOMEDMapping(
        code="900000000000368",
        term="Pseudarthrosis rate",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        is_extension=True,
        parent_code="900000000000306",  # Fusion Rate
        synonyms=["Pseudoarthrosis rate", "Non-union rate",
                  "Failed fusion rate"],
        korean_term="가관절 발생률",
    ),
    "Neurological Recovery": SNOMEDMapping(
        code="900000000000369",
    ...
    "Subsidence Measurement": SNOMEDMapping(
        code="900000000000370",
    ...
    "Adjacent Disc Degeneration": SNOMEDMapping(
        code="900000000000377",
    ...
    "Albumin": SNOMEDMapping(
        code="900000000000378",
    ...
    "Bowel/Bladder Function": SNOMEDMapping(
        code="900000000000379",
    ...
    "Brief Pain Inventory": SNOMEDMapping(
        code="900000000000380",
    ...
    "Cage Height": SNOMEDMapping(
        code="900000000000382",
    ...
    "Coronal Correction": SNOMEDMapping(
        code="900000000000384",
    ...
    "Cross-Sectional Area": SNOMEDMapping(
        code="900000000000385",
    ...
    "Delirium": SNOMEDMapping(
        code="900000000000387",
    ...
    "Drain Duration": SNOMEDMapping(
        code="900000000000388",
    ...
    "Dysphagia": SNOMEDMapping(
        code="900000000000389",
    ...
    "Dysphonia": SNOMEDMapping(
        code="900000000000390",
        term="Dysphonia",
        semantic_type=SNOMEDSemanticType.FINDING,
        is_extension=True,
        parent_code="900000000000657",  # Complication Outcome
    ...
    "Fatty Infiltration": SNOMEDMapping(
        code="900000000000393",
    ...
    "Fluoroscopy Dose": SNOMEDMapping(
        code="900000000000394",
    ...
    "Fluoroscopy Time": SNOMEDMapping(
        code="900000000000395",
    ...
    "Fusion Segment Length": SNOMEDMapping(
        code="900000000000396",
    ...
    "Global Tilt": SNOMEDMapping(
        code="900000000000398",
    ...
    "Grip Strength": SNOMEDMapping(
        code="900000000000399",
    ...
    "Hardware Failure": SNOMEDMapping(
        code="900000000000508",
    ...
    "Hemoglobin": SNOMEDMapping(
        code="900000000000509",
    ...
    "ICU Stay": SNOMEDMapping(
        code="900000000000510",
    ...
    "JOABPEQ": SNOMEDMapping(
        code="900000000000512",
    ...
    "Learning Curve": SNOMEDMapping(
        code="900000000000513",
    ...
    "Neurological Deficit": SNOMEDMapping(
        code="900000000000514",
    ...
    "Pain DETECT": SNOMEDMapping(
        code="900000000000517",
    ...
    "Pelvic Obliquity": SNOMEDMapping(
        code="900000000000518",
    ...
    "RBC Transfusion": SNOMEDMapping(
        code="900000000000520",
    ...
    "Radiculopathy": SNOMEDMapping(
        code="900000000000523",
        term="Radiculopathy",
        semantic_type=SNOMEDSemanticType.FINDING,
        is_extension=True,
        parent_code="900000000000657",  # Complication Outcome
    ...
    "Readmission Rate": SNOMEDMapping(
        code="900000000000524",
    ...
    "Screw Diameter": SNOMEDMapping(
        code="900000000000526",
    ...
    "Screw Length": SNOMEDMapping(
        code="900000000000527",
    ...
    "Screw Misplacement": SNOMEDMapping(
        code="900000000000528",
    ...
    "Sympathetic Dysfunction": SNOMEDMapping(
        code="900000000000529",
    ...
    "T1 Pelvic Angle": SNOMEDMapping(
        code="900000000000530",
    ...
    "Thoracic Kyphosis": SNOMEDMapping(
        code="900000000000531",
    ...
    "Urinary Tract Infection": SNOMEDMapping(
        code="900000000000532",
    ...
    "Vascular Injury": SNOMEDMapping(
        code="900000000000533",
    ...
    "Vertebral Endplate Fracture": SNOMEDMapping(
        code="900000000000534",
    ...
    "Vitamin D": SNOMEDMapping(
        code="900000000000535",
    ...
    "Walking Ability": SNOMEDMapping(
        code="900000000000536",
    ...
    "Wound Complication": SNOMEDMapping(
        code="900000000000537",
    ...
    # ============================================================
    # v1.25.0: New Outcome Concepts (observable_ext range 800+)
    # ============================================================
    "PROMIS-10": SNOMEDMapping(
        code="900000000000800",
        term="PROMIS-10 Global Health score",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000660",  # Patient-Reported Outcome
        is_extension=True,
        synonyms=["PROMIS-10", "PROMIS Global-10", "PROMIS Global Health"],
        abbreviations=["PROMIS-10"],
        korean_term="PROMIS-10 전반 건강 점수",
    ),
    "QALY": SNOMEDMapping(
        code="900000000000801",
        term="Quality-adjusted life year",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000658",  # Surgical Efficiency Outcome
        is_extension=True,
        synonyms=["Quality adjusted life year", "Cost per QALY"],
        abbreviations=["QALY"],
        korean_term="질보정 수명년",
    ),
    "Disc Height Index": SNOMEDMapping(
        code="900000000000802",
        term="Disc height index measurement",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000656",  # Radiological Outcome
        is_extension=True,
        synonyms=["DHI", "Disc space height ratio", "Disc height ratio"],
        abbreviations=["DHI"],
        korean_term="추간판 높이 지수",
    ),
    "Macnab Criteria": SNOMEDMapping(
        code="900000000000803",
        term="Modified Macnab criteria assessment",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000660",  # Patient-Reported Outcome
        is_extension=True,
        synonyms=["Modified MacNab", "MacNab classification", "MacNab outcome"],
        korean_term="맥낵 기준 평가",
    ),
    "Opioid Consumption": SNOMEDMapping(
        code="900000000000804",
        term="Postoperative opioid consumption",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000658",  # Surgical Efficiency Outcome
        is_extension=True,
        synonyms=["Narcotic use", "Opioid use", "Morphine equivalent dose",
                  "MED (morphine equivalent dose)"],
        korean_term="아편유사제 소비량",
    ),
    "Timed Up and Go": SNOMEDMapping(
        code="900000000000805",
        term="Timed Up and Go test",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000655",  # Functional Outcome
        is_extension=True,
        synonyms=["TUG test", "TUG", "Timed up-and-go"],
        abbreviations=["TUG"],
        korean_term="기립보행검사",
    ),
    "ICER": SNOMEDMapping(
        code="900000000000806",
        term="Incremental cost-effectiveness ratio",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000658",  # Surgical Efficiency Outcome
        is_extension=True,
        synonyms=["Cost-effectiveness ratio", "Cost per QALY gained"],
        abbreviations=["ICER"],
        korean_term="점증적 비용효과비",
    ),
    "Spinal Cord Perfusion": SNOMEDMapping(
        code="900000000000807",
        term="Spinal cord perfusion measurement",
        semantic_type=SNOMEDSemanticType.OBSERVABLE_ENTITY,
        parent_code="900000000000659",  # Neurological Outcome
        is_extension=True,
        synonyms=["Spinal cord perfusion pressure", "SCPP"],
        abbreviations=["SCPP"],
...
SPINE_ANATOMY_SNOMED: dict[str, SNOMEDMapping] = {
    ...
    # === v1.19.2 EXPANSION: Thoracic Disc Levels ===
    # Extension codes: 900000000000414 ~ 900000000000422

    "T2-3": SNOMEDMapping(
        code="900000000000414",
    ...
    "Multi-level": SNOMEDMapping(
        code="900000000000422",
    ...
    "T10-11": SNOMEDMapping(
        code="900000000000426",
    ...
    # ============================================================
    # v1.25.0: New Anatomy Concepts
    # ============================================================
    "Disc Space": SNOMEDMapping(
        code="900000000000470",
        term="Intervertebral disc space",
        semantic_type=SNOMEDSemanticType.BODY_STRUCTURE,
        parent_code="900000000000665",  # Spine
        is_extension=True,
        synonyms=["Disc space", "Intervertebral space", "Disc height space"],
        korean_term="추간판 공간",
    ),
    "Facet Joint": SNOMEDMapping(
        code="900000000000471",
        term="Zygapophyseal joint",
        semantic_type=SNOMEDSemanticType.BODY_STRUCTURE,
        parent_code="900000000000665",  # Spine
        is_extension=True,
        synonyms=["Facet joint", "Zygapophysial joint", "Articular facet"],
        korean_term="후관절",
    ),
    "Neural Foramen": SNOMEDMapping(
        code="900000000000472",
        term="Intervertebral foramen",
        semantic_type=SNOMEDSemanticType.BODY_STRUCTURE,
        parent_code="900000000000665",  # Spine
        is_extension=True,
        synonyms=["Neural foramen", "Neuroforamen", "Intervertebral foramen"],
        korean_term="추간공",
    ),
    "Spinal Canal": SNOMEDMapping(
        code="900000000000473",
        term="Vertebral canal",
        semantic_type=SNOMEDSemanticType.BODY_STRUCTURE,
        parent_code="900000000000665",  # Spine
        is_extension=True,
        synonyms=["Spinal canal", "Central canal", "Vertebral canal"],
        korean_term="척추관",
    ),
    "Thecal Sac": SNOMEDMapping(
        code="900000000000474",
        term="Thecal sac",
        semantic_type=SNOMEDSemanticType.BODY_STRUCTURE,
        parent_code="900000000000665",  # Spine
        is_extension=True,
